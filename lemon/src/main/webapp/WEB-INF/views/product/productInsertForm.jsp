		...
		<div class="container">
			<div class="row">
				<div class=" animate-box" align="center">
					<h3>레몬에서 거래하기</h3>
					<h4>${param.productCategory}/${param.productInfo }</h4>
					<form action="productInsert.do" method="post"
						...
						<div class="row form-group">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea id="productSubject" name="productSubject"
										required="required" rows=10 cols=60 wrap=on
										class="form-control" placeholder="내용 작성" style="width: 844px;"></textarea>
							...
							<div class="form-group">
								...
								<input type="submit" value="작성하기" class=" btn-primary">
							</div>
						</div>
					</form>
				</div>
