		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<h2>생활 용품 판매</h2>
					<p>원 플러스 원? 여기, 레몬마켓에서는 재화창출의 기회입니다</p>
				</div>
			</div>
			<br>
			<div align="center">
				<c:if test="${not empty id }">
					<form id="insert" action="productInsertForm.do" method="post">
						<input type="hidden" name="productCategory" value="리빙"> <input
	...
	<div
		...
		<form action="productSearch.do" id="search" method="post"
			...
			<input type="hidden" name="productCategory" id="productCategory"
				value="리빙"> <input type="text" class="form-control"
	...
	<div align="center" class="pager">
		<ul class="listCenter">
			<c:forEach var="n" begin="1" end="${totalPage }">
				<li><a href="livingproductListSell.do?viewPage=${n }">${n  }
				</a></li>
			</c:forEach>
		</ul>
	</div>
