		...
		<form id="reportForm" target="parentForm"
			...
			<div class="form_div">
				<input type="hidden" id="productId" name="productId"
					value="${reply.productId}">
					<label for="reportReporter">신고자 </label>
					<input class="field_class" type="text" id="reportReporter"
